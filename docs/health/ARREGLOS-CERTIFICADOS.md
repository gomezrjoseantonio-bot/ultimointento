...
| 2026-07-19 · barrido muerto | Apartados por la regla especial NO borrados (ErrorBoundary · navigation/Header · FiscalPageShell · FormErrorSummary) | `find src/components/common/ErrorBoundary.tsx src/components/navigation/Header.tsx src/modules/horizon/fiscalidad/components/FiscalPageShell.tsx src/components/common/FormErrorSummary.tsx 2>/dev/null \| wc -l` | `4` |
| 2026-07-19 · barrido muerto | Candados DBSchema preservados (guardas de tsc · muertos por import pero load-bearing) | `find src/services/__typeguards__/dbschema-nombres.ts src/services/__typeguards__/dbschema-valores.ts 2>/dev/null \| wc -l` | `2` |
