        ...
        <div className="flex items-center space-x-3">
          ...
          {activeTab !== 'CONSOLIDADO' && onAddLine && (
            <button
              ...
              className="atlas-atlas-atlas-atlas-atlas-btn-primary inline-flex items-center px-4 py-2"
            >
          ...
          <nav className="-mb-px flex space-x-8">
            {availableTabs.map((tab) => (
              ...
              >
                ...
                {tab === 'CONSOLIDADO' && (
                  <span className="atlas-atlas-atlas-atlas-atlas-btn-primary text-primary-800 text-xs px-2 py-1">
                    Auto
                  </span>
                )}
              </button>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-info-800 mt-1">
                ...
                <span className="atlas-atlas-atlas-atlas-atlas-btn-primary inline-block w-3 h-3 mx-1"></span>Personal 
