      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-end">
          <button
            onClick={handleSave}
            disabled={loading}
            className="atlas-atlas-atlas-atlas-btn-primary inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium bg-atlas-blue hover: focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-atlas-blue disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
