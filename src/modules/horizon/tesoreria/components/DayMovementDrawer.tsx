                        ...
                        {isEditing ? (
                          <>
                            <button
                              ...
                              className="atlas-atlas-btn-primary flex items-center gap-1 px-3 py-1 text-sm text-green-700 rounded"
                            >
                              <Check size={14} />
                              Guardar
                            </button>
                          ...
                          <>
                            {movement.status !== 'conciliado' && movement.unifiedStatus !== 'conciliado' && (
                              <button
                                ...
                                className="atlas-atlas-btn-primary flex items-center gap-1 px-3 py-1 text-sm text-blue-700 rounded"
                              >
                                <Check size={14} />
                                Conciliar
                              </button>
