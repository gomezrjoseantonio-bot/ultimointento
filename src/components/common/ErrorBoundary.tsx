    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center py-12 px-4">
          <div className="atlas-atlas-atlas-btn-destructive border border-red-200 p-8 max-w-lg w-full">
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className="mb-6">
                ...
                <pre className="atlas-atlas-atlas-btn-destructive text-xs p-3 rounded overflow-auto text-red-800">
