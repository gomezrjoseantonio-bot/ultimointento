// Panel · "En diez segundos" · acciones rápidas con destino real
...
const AccionesRapidas: React.FC<AccionesRapidasProps> = ({
  ...
  <section className={styles.sec}>
    ...
    <div className={styles.grid}>
      ...
      <button className={styles.btn} onClick={onOpenUpdateValues}>
        <span className={styles.ic}>
          <Icons.Refresh size={18} strokeWidth={1.8} />
        </span>
        <span>
          <span className={styles.t}>Actualizar valores</span>
          <span className={styles.s}>IPC, Euríbor, inmuebles e inversiones</span>
        </span>
      </button>
    </div>
  </section>
