        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="inline-flex items-center atlas-atlas-atlas-btn-primary  text-sm rounded-md hover:atlas-atlas-atlas-btn-primary"
              >
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="atlas-atlas-atlas-btn-primary rounded-md hover:atlas-atlas-atlas-btn-primary disabled:opacity-50"
            >
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-200">
          ...
          <button
            type="submit"
            className="atlas-atlas-atlas-btn-primary rounded-md hover:atlas-atlas-atlas-btn-primary"
          >
