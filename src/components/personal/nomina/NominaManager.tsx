                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      {nomina.activa && (
                        <span className="atlas-atlas-atlas-atlas-btn-primary inline-flex items-center px-2 py-1 text-xs font-medium text-blue-800">
                          Activa
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    {!nomina.activa && (
                      <button
                        ...
                        className="btn-secondary-horizon atlas-atlas-atlas-atlas-btn-primary px-3 py-1 text-sm text-blue-600 "
                      >
                        Activar
                      </button>
                    )}
