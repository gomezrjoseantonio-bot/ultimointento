...
async function sembrarEstructuras(): Promise<void> {
  ...
  await sembrar('compromisosRecurrentes', [
    { id: 11, alias: 'Seguro decesos', ambito: 'personal', proveedor: { nombre: 'Segurcaixa Adeslas' }, numeroContrato: '07085234611', patron: { tipo: 'mensualDiaFijo', dia: 2 }, importe: { modo: 'fijo', importe: 24.9 }, cuentaCargo: SANTANDER, conceptoBancario: 'SEGURCAIXA ADESLAS', metodoPago: 'domiciliacion', familia: 'seguros_alarmas', estado: 'activo' },
    { id: 12, alias: 'Renting Ayvens', ambito: 'personal', tipo: 'otro', proveedor: { nombre: 'Ayvens' }, patron: { tipo: 'mensualDiaFijo', dia: 8 }, importe: { modo: 'fijo', importe: 351.13 }, cuentaCargo: SANTANDER, conceptoBancario: 'AYVENS', metodoPago: 'domiciliacion', familia: 'transporte', estado: 'activo' },
    { id: 13, alias: 'Comunidad Tenderina', ambito: 'inmueble', inmuebleId: 4, proveedor: { nombre: 'Comunidad Propietarios Tenderina' }, patron: { tipo: 'mensualDiaFijo', dia: 5 }, importe: { modo: 'fijo', importe: 95 }, cuentaCargo: SANTANDER, conceptoBancario: 'COMUNIDAD PROPIETARIOS TENDERINA', metodoPago: 'domiciliacion', familia: 'comunidad', estado: 'activo' },
    { id: 14, alias: 'Agua Tenderina', ambito: 'inmueble', inmuebleId: 4, subtipo: 'agua', proveedor: { nombre: 'Canal de Isabel II' }, patron: { tipo: 'cadaNMeses', cadaNMeses: 2, mesAncla: 2, dia: 15 }, importe: { modo: 'variable', importeMedio: 42 }, cuentaCargo: SANTANDER, conceptoBancario: 'CANAL DE ISABEL II', metodoPago: 'domiciliacion', familia: 'suministro', estado: 'activo' },
  ]);
