        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="atlas-atlas-atlas-atlas-atlas-btn-primary p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-success-900">Aplicaciones</span>
            </div>
            <p className="text-2xl font-bold text-success-600 mt-1">{stats.totalApplications}</p>
          </div>
              ...
              <div key={movement.id} className="bg-white p-3 border">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-error-600">{movement.amount.toFixed(2)}€</p>
