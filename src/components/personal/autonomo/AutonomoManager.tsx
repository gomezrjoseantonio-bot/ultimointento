          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="atlas-atlas-atlas-btn-primary inline-flex items-center px-3 py-1 text-sm"
              >
              ...
              <button
                ...
                className="atlas-atlas-atlas-btn-destructive inline-flex items-center px-3 py-1 text-sm"
              >
                <Plus className="w-4 h-4 mr-1" />
                Gasto
              </button>
          ...
          <div className="bg-white border border-gray-200 p-6">
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              {activoAutonomo.ingresosFacturados
                ...
                .map((ingreso) => (
                  <div key={ingreso.id} className="atlas-atlas-atlas-btn-primary flex items-center justify-between p-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        {ingreso.conIva && ingreso.tipoIva && (
                          <span className="atlas-atlas-atlas-btn-primary ml-2 text-xs text-blue-800 px-2 py-1 rounded">
                            IVA {ingreso.tipoIva}%
                          </span>
                        )}
                      </p>
          ...
          <div className="bg-white border border-gray-200 p-6">
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              {activoAutonomo.gastosDeducibles
                ...
                .sort((a, b) => new Date(b.fecha).getTime() - new Date(a.fecha).getTime())
                .map((gasto) => (
                  <div key={gasto.id} className="atlas-atlas-atlas-btn-destructive flex items-center justify-between p-3">
                    <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      {autonomo.activo && (
                        <span className="atlas-atlas-atlas-btn-primary inline-flex items-center px-2 py-1 text-xs font-medium text-green-800">
                          Activo
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    {!autonomo.activo && (
                      <button
                        ...
                        className="atlas-atlas-atlas-btn-primary px-3 py-1 text-sm text-green-600 border border-green-600 rounded hover: "
                      >
                        Activar
                      </button>
                    )}
