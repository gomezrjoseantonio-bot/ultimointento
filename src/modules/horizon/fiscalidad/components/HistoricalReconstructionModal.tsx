          ...
          {isProcessing && progress && (
            <div className="space-y-3">
              ...
              <div className="w-full bg-gray-200 h-3">
                <div 
                  className="atlas-atlas-atlas-btn-primary h-3 transition-all duration-300"
          ...
          <div className="flex space-x-3 pt-4 border-t border-gray-200">
            ...
            {!result && (
              <button
                ...
                disabled={isProcessing}
                className="atlas-atlas-atlas-btn-primary flex-1 flex items-center justify-center space-x-2 px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isProcessing ? (
                  <>
