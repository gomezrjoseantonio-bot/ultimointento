    ...
    <div className={`bg-white border shadow-sm ${className}`}>
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          {activeJobs.length > 0 && (
            <span className="atlas-atlas-atlas-btn-primary inline-flex px-2 py-1 text-xs font-medium text-primary-800">
                  ...
                  <div className="flex items-center space-x-2">
                    {job.status === 'ERROR' && (
                      <button
                        ...
                        className="atlas-atlas-atlas-btn-destructive text-xs px-2 py-1 bg-error-100 text-error-700 rounded hover:"
                      >
                        Reintentar
                      </button>
                    )}
