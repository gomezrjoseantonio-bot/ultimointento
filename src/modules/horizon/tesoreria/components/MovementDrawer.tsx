    ...
    return (
      <div className="flex items-center gap-2">
        ...
        {movement.categoria && status === 'sin_match' && (
          <span className="atlas-atlas-atlas-atlas-atlas-btn-primary inline-flex items-center gap-1 px-2 py-1 text-xs text-primary-700">
              ...
              <div className="btn-secondary-horizon atlas-atlas-atlas-atlas-atlas-btn-primary ">
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="atlas-atlas-atlas-atlas-atlas-btn-primary flex-1 px-4 py-2 disabled:bg-gray-300 disabled:cursor-not-allowed"
                  >
              ...
              <>
                ...
                {movement.statusConciliacion === 'sin_match' && (
                  <button
                    ...
                    className="atlas-atlas-atlas-atlas-atlas-btn-primary w-full flex items-center justify-center gap-2 px-4 py-2"
                  >
                ...
                <button
                  ...
                  className="atlas-atlas-atlas-atlas-atlas-btn-destructive w-full flex items-center justify-center gap-2 px-4 py-2 bg-hz-error hover:"
                >
