        ...
        <div className="bg-white border-t border-gray-200 mt-8 shadow-sm">
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="text-sm font-medium atlas-atlas-atlas-atlas-btn-primary hover:bg-navy-800 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
