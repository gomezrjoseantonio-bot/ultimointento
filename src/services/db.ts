...
export interface AtlasHorizonDB extends DBSchema {
  ...
  // V95 (E3.1 · §7.3): el CATÁLOGO NACIONAL aprendido · NIF/nombre → proveedor → familia.
  // COMPARTIDO, no del cliente: lo que uno enseña de WiZink lo heredan los demás
  // el día que esto viaje a un servidor. La semilla NO vive aquí (viaja en el
  // código, `catalogoNacional/entidadesNacionales.ts`): aquí solo lo aprendido.
  catalogoProveedores: { key: IDBValidKey; value: EntradaCatalogoProveedor; indexes: { 'clave': IDBValidKey; 'nif': IDBValidKey } };
