          ...
          <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-gray-200 shadow-lg z-20">
            <div className="py-1">
              ...
              <button
                ...
                className="atlas-atlas-atlas-btn-destructive w-full px-4 py-2 text-left text-sm text-red-600 hover: flex items-center gap-2"
              >
          ...
          <div className="bg-white p-6 w-full max-w-lg">
            ...
            <div>
              ...
              {deleteConfirmation.references?.includes('préstamos') ? (
                  ...
                  <div>
                    <div className="atlas-atlas-atlas-btn-destructive border border-red-200 p-3 mb-4">
                    ...
                    <div className="flex justify-end space-x-3">
                      ...
                      <button
                        ...
                        className="atlas-atlas-atlas-btn-destructive px-4 py-2 text-sm font-medium border border-transparent disabled:opacity-50"
                      >
