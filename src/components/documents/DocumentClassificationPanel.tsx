    ...
    >
      ...
      <header className="flex items-center justify-between">
        ...
        <button
          ...
          className="atlas-atlas-atlas-atlas-btn-primary flex items-center gap-2 px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
        >
      ...
      {formData.destino === 'Inmueble' && formData.aeatClassification && (
        <section className="atlas-atlas-atlas-atlas-btn-primary space-y-4 p-4" aria-labelledby="aeat-title">
