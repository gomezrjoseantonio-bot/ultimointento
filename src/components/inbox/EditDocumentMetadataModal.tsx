    ...
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full" style={{ borderRadius: 'var(--r-md)' }}>
          <div className="px-5 py-4 border-b flex items-center justify-between" style={{ borderColor: 'var(--atlas-v5-line)' }}>
            <h3 className="text-base font-semibold" style={{ color: 'var(--atlas-v5-ink)' }}>Editar metadata documento</h3>
          ...
          <div className="px-5 py-4 space-y-3">
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: 'var(--atlas-v5-ink-2)' }}>Tipo</label>
              <select
                value={tipo}
            ...
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: 'var(--atlas-v5-ink-2)' }}>Fecha emisión</label>
              <input
                type="date"
                value={issueDate}
            ...
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: 'var(--atlas-v5-ink-2)' }}>Proveedor</label>
              <input
                type="text"
                value={proveedor}
            ...
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: 'var(--atlas-v5-ink-2)' }}>Importe (€)</label>
              <input
                type="number"
                step="0.01"
                value={amount}
            ...
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: 'var(--atlas-v5-ink-2)' }}>Descripción</label>
              <textarea
                value={description}
          ...
          <div className="px-5 py-3 border-t flex items-center justify-end gap-2" style={{ borderColor: 'var(--atlas-v5-line)', background: 'var(--atlas-v5-bg)' }}>
            <button
              type="button"
