...
const InmueblesNuevoContratoGestion = lazyWithPreload(() => import('./modules/inmuebles/wizards/NuevoContratoGestion'));
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path="contratos" element={
              ...
              <Route path="gestion/nuevo" element={
                <React.Suspense fallback={<LoadingSpinner />}>
                  <InmueblesNuevoContratoGestion />
                </React.Suspense>
              } />
            </Route>
