      ...
      return (
        <div className="flex items-center justify-center h-64 bg-gray-50">
          <div className="text-center">
            ...
            <button className="atlas-atlas-atlas-btn-primary mt-2 inline-flex items-center px-3 py-1 text-xs text-primary-700 rounded">
          ...
          <div className="space-y-2">
            {zipEntries.map((entry, index) => (
              ...
              >
                ...
                <button className="atlas-atlas-btn-ghost-horizon text-xs">
                  Ver
                </button>
              </div>
            ))}
