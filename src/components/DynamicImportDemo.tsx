...
Bundle optimization working - heavy library only loaded when needed.`);
  ...
  return (
    <div className="p-6 bg-white shadow-md">
      ...
      <div className="space-y-4">
        <div>
          <button
            ...
            disabled={isLoading}
            className="atlas-atlas-btn-primary px-4 py-2 rounded mr-4 disabled:opacity-50"
          >
      ...
      {result && (
        <div className="atlas-atlas-btn-primary mt-6 p-4 border border-green-200 rounded">
