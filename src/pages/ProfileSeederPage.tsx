                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary px-3 py-1 text-xs disabled:opacity-50"
                    >
      ...
      {showMapping && previewData && currentProfile && (
        <div className="bg-white border border-neutral-200 p-6">
          ...
          {previewData.sheetName && (
            <div className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary mb-4 p-3">
      ...
      <div className="bg-white border border-neutral-200 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary flex items-center gap-2 px-4 py-2 disabled:opacity-50"
          >
