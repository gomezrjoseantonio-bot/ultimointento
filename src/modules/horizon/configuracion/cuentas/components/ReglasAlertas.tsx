                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        {rule.isActive ? (
                          <span className="atlas-atlas-btn-primary inline-flex items-center px-2 py-0.5 text-xs font-medium text-green-800">
                            Activa
                          </span>
                        ) : (
          ...
          <div className="bg-white max-w-md w-full">
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button
                ...
                className="atlas-atlas-btn-destructive inline-flex items-center px-4 py-2"
              >
                Eliminar
              </button>
            </div>
