...
const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose }) => {
  ...
  const allCommands: Command[] = useMemo(() => [
    ...
    },
    {
      ...
      icon: Building,
      action: () => { navigate('/inmuebles'); onClose(); },
      category: 'navigation',
    ...
    },
    {
      ...
      icon: Banknote,
      action: () => { navigate('/tesoreria'); onClose(); },
      category: 'navigation',
    ...
    },
    {
      ...
      icon: BarChart3,
      action: () => { navigate('/fiscal'); onClose(); },
      category: 'navigation',
    ...
    },
    {
      ...
      icon: Settings,
      action: () => { navigate('/ajustes'); onClose(); },
      category: 'navigation',
    ...
    // Action commands
    {
      ...
      icon: Building,
      action: () => { navigate('/inmuebles?action=new'); onClose(); },
      category: 'action',
    ...
    },
    {
      ...
      icon: Banknote,
      action: () => { navigate('/tesoreria?action=import'); onClose(); },
      category: 'action',
