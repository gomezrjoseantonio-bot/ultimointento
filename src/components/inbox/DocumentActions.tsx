      ...
      {isFEINDocument && (
        <>
          ...
          <button
            ...
            className="atlas-atlas-atlas-btn-primary p-1.5 text-blue-600 hover:text-blue-800 hover:"
          ...
          {hasLoanId && (
            <button
              ...
              className="atlas-atlas-atlas-btn-primary p-1.5 text-green-600 hover:text-green-800 hover:"
