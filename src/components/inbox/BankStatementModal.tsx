          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="atlas-atlas-btn-primary flex items-center gap-2 px-4 py-2"
              >
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="atlas-atlas-btn-primary flex-1 px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
