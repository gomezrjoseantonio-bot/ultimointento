      ...
      (t) => (
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary px-2 py-1 text-xs rounded"
            >
            Ver en Movimientos
          </button>
        </div>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-80 lg:flex-shrink-0 border-r border-neutral-200">
            ...
            {showBulkActions && selectedDocuments.length > 0 && (
              <div className="btn-secondary-horizon atlas-atlas-atlas-atlas-atlas-atlas-btn-primary p-4 ">
              ...
              >
                  ...
                  <button
                    ...
                    className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary flex items-center gap-1 px-3 py-1 text-xs"
              >
