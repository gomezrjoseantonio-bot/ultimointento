      ...
      {mode === 'manual' && (
        <div className="space-y-3">
          ...
          <button
            ...
            className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary atlas-atlas-atlas-atlas-atlas-atlas-btn-primary w-full flex items-center justify-center px-3 py-2 text-sm text-primary-700 rounded hover: "
          >
