              ...
              <div key={rule.id} className="px-6 py-4 border-b border-neutral-200">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        {rule.isActive ? (
                          <span className="atlas-atlas-atlas-atlas-atlas-btn-primary inline-flex items-center px-2 py-0.5 text-xs font-medium text-success-800">
                            Activa
                          </span>
                        ) : (
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      {rule.isActive ? (
                        <ToggleRight className="w-6 h-6 text-success-600" style={{ strokeWidth: 1.5 }} />
                      ) : (
            ...
            <div className="px-6 py-4">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {formErrors.name && (
                    <p className="text-xs text-error-600 mt-1">{formErrors.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {formErrors.description && (
                    <p className="text-xs text-error-600 mt-1">{formErrors.description}</p>
                  )}
                </div>
          ...
          <div className="bg-white max-w-md w-full">
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button
                ...
                className="atlas-atlas-atlas-atlas-atlas-btn-destructive inline-flex items-center px-4 py-2"
              >
                Eliminar
              </button>
            </div>
