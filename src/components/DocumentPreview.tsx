      ...
      setPreviewContent(`
        <div class="p-4 bg-white border rounded">
          ...
          <div class="mt-4 pt-2 border-t">
            <button class="inline-flex items-center px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded">
      ...
      return (
        <div className="flex items-center justify-center h-64 bg-gray-50 rounded-lg">
          <div className="text-center">
            ...
            <button className="mt-2 inline-flex items-center px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded">
