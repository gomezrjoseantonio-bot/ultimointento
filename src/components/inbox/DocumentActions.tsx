      ...
      {isFEINDocument && (
        <>
          ...
          <button
            ...
            className="atlas-atlas-atlas-atlas-atlas-btn-primary p-1.5 text-atlas-blue hover:text-primary-800 hover:"
          ...
          {hasLoanId && (
            <button
              ...
              className="atlas-atlas-atlas-atlas-atlas-btn-primary p-1.5 text-success-600 hover:text-success-800 hover:"
