        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 justify-between items-start sm:items-center">
          ...
          <div className="flex gap-2">
            ...
            <div className="relative">
              ...
              <label
                htmlFor="file-upload"
                className="atlas-atlas-atlas-atlas-atlas-atlas-btn-primary shadow-sm text-sm font-medium cursor-pointer"
              >
            ...
            {/* DEV Test button */}
            {isDev && (
              <button className="atlas-atlas-atlas-atlas-atlas-atlas-btn-secondary shadow-sm" onClick={handleTestOCR}>
                🧪 Probar OCR (DEV)
              </button>
            )}
          </div>
            ...
            <div className="w-96 bg-white border-l border-gray-200 flex flex-col">
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <button className="atlas-atlas-atlas-atlas-atlas-atlas-btn-ghost" onClick={() => setSelectedDocument(null)} aria-label="Cerrar detalles">
                    <X className="h-5 w-5" />
                  </button>
                </div>
              </div>
    ...
    <div className="atlas-card p-4">
      <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col space-y-2 ml-4">
          <button 
            className="atlas-atlas-atlas-atlas-atlas-atlas-btn-ghost" 
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {document.documentType === 'factura' && (
          <button className="atlas-atlas-atlas-atlas-atlas-atlas-btn-secondary w-full justify-center" onClick={onReprocessOCR}>
      ...
      {/* Logs */}
      <div>
        <button className="atlas-atlas-atlas-atlas-atlas-atlas-btn-ghost w-full justify-between text-sm font-medium" onClick={onToggleLogs}>
