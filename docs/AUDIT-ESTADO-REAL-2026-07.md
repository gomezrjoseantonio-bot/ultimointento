...
**Regla de cabeceras** referenciada en `docs/GUIA-DISENO-V5-atlas.md:50-51`.
...
| **Migración de diseño a V5** | ⚠ **A MEDIAS · ~23,5 %** | `src/design-system/` contiene **solo** `v5/` (no hay v1-v4); "migrar" = adoptar el barrel `design-system/v5`. Medición: **137 / 583** componentes `.tsx` de producción importan `design-system/v5` ≈ **23,5 %** (cota inferior: hay consumo vía CSS modules no contabilizado). Aviso: `HANDOFF-V5-atlas.md` (raíz) documenta la V5 del **modelo de datos** (stores 59→39, DB v64), **no** el design-system (`HANDOFF-V5-atlas.md:1-9`); la guía de diseño real es `docs/GUIA-DISENO-V5-atlas.md`. |
