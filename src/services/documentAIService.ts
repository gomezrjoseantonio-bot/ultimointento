...
export const processDocumentAIResponse = (apiResponse: any, filename: string): OCRResult => {
  ...
  return {
    ...
    data: extractedData ? {
      ...
      nif_proveedor:  extractedData.nif_proveedor  != null ? String(extractedData.nif_proveedor)  : undefined,
      numero_contrato: extractedData.numero_contrato != null ? String(extractedData.numero_contrato) : undefined,
      cups:           extractedData.cups           != null ? String(extractedData.cups)           : undefined,
